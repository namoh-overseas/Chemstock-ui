...
import { addProduct } from "@/app/api/seller/addProduct";
...
export default function AddProductPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await addProduct(formData, imageUrl);
      if (response) {
              ...
              <div className="fixed top-0 left-0 right-0 z-50 flex items-center justify-center w-screen h-screen bg-black/50">
                <div className="flex items-center justify-center relative">
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-lg">
                    <h2 className="text-lg font-semibold mb-4">Stock Added!</h2>
                    <p className="mb-4 text-center max-w-xl mx-auto">
                      Your stock has been added successfully. Once approved by the admin, it will be listed on the stocks page.
                    </p>
                    <Button
