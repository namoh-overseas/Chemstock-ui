...
import { getProduct } from "@/app/api/seller/updateProduct";
import { updateProduct } from "@/app/api/seller/updateProduct";
...
export default function UpdateProductPage(props: { params: Promise<Params> }) {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-2xl">
      <h1 className="text-3xl font-bold mb-8">Update Stock</h1>

      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="">
          <p className="text-red-500"><span className="font-bold text-gray-500">Note: </span> <span>After updating the product, Admin will <mark className="text-blue-500 bg-blue-100 p-0.5 rounded-full">&nbsp;approve </mark>&nbsp;it and then it will be listed on the <mark className="text-blue-500 bg-blue-100 p-0.5 rounded-full">&nbsp;stocks </mark>&nbsp;page.</span></p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className="text-[10px] text-red-500">
            <span className="font-semibold text-gray-500">Note:</span> If you doesn't upload
            an image or the provided image is invalid, then we will use{" "}
            <FallbackImage
              src={"/default-product.png"}
              alt="Default Product"
              width={400}
              height={400}
              className="size-8 inline object-cover mx-auto"
              priority
            />
          </p>
              ...
              <div className="fixed top-0 left-0 right-0 z-50 flex items-center justify-center w-screen h-screen bg-black/50">
                <div className="flex items-center justify-center relative">
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-lg">
                    <h2 className="text-lg font-semibold mb-4">Stock Updated!</h2>
                    <p className="mb-4 text-center max-w-xl mx-auto">
                      Your stock has been updated successfully.
                    </p>
                    <Button
                      onClick={() => redirect("/seller?tab=products")}
                      className="w-full"
                    >
